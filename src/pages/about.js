    ...
    <article className="content">
      <div className="container">
        ...
        <div className="postbody">
          <div>
            <h2>
              都内近郊のスポットでゆるく楽しく、四季折々の花の撮影会＆お茶！をするサークルです！
            </h2>
            ...
            <ul>
              ...
              <li>
                <p>撮影会近くのカフェで談笑（1時間程度・状況により撮影のみ）</p>
              </li>
            </ul>
            <p>
              立ち上げ後すぐに活動休止していたため、
              これから試行錯誤してきますが、
              基本は都内中心にテーマに合わせて撮影スポットを決めて、
              1～4時間くらい撮影して、近くのおしゃれなカフェやお店で1～2時間くらい、
              撮った写真見せ合ったり、感想などを中心に談笑、
              人数が集まってきたら、関東中心に半日以上の撮影イベント等も考えています！
            </p>
            <p>
              管理人がカメラ初心者ということもあり、 応募条件は初心者歓迎、
              初心者にも合わせて楽しめる中、上級者歓迎、
            ...
            <h3 id="以下の点についてご理解いただけない場合には、退会を含めた対応を取らせていただきます">
